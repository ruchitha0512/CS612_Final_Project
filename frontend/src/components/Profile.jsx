...
const DEFAULT_AVATAR =
  ...
  const Profile = () => {
    ...
    const [profile, setProfile] = useState({
      ...
      posts_count: 0,
      likes_given_count: 0,
      followers_count: 0, // Add followers count
      following_count: 0, // Add following count
    });
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        const profileData = {
          ...
          followers_count: data.followers_count || 0, // Update followers count
          following_count: data.following_count || 0, // Update following count
        };
